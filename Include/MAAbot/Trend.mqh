//+------------------------------------------------------------------+
//|                                                       Trend.mqh  |
//|   MAAbot v2.7.0 - Análise de Tendência MTF                       |
...
//-------------------------- TENDÊNCIA (MTF) -------------------------------//
// Análise de tendência usando ADX + EMA + Preço vs EMA
int TrendDirection(double &score_out, bool &isTrending_out) {
   ...
   // Pesos: ADX, EMA Cross, Preço vs EMA Lenta
   double wAdx = 1.0, wEMA = 1.0, wPx = 0.5;
   double sumw = (wAdx + wEMA + wPx);
   ...
   double sTot = sTF1; double adx2 = 0.0;
